...
void openInverterDialog(BuildContext context) {
        ...
        child: Column(
          ...
          children: [
            Wrap(
              spacing: 20,
              children: [
                ButtonBuilder(title: "Comp Hz", choice: "comp_hz", section: 4),
                ButtonBuilder(
                    title: "Circ Pump Hz", choice: "circ_pump_hz", section: 4),
              ],
            ),
            ButtonBuilder(
                title: "Condenser Hz", choice: "condenser_hz", section: 4),
          ],
        ),
      ),
    ],
